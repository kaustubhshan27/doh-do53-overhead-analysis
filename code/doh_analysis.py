...
def main():
    ...
    # with dns.query.httpsession() as session:
    #     print("Resolving with Google DNS...")
    #     resolve_doh(GOOGLE_DNS_HTTPS, session=session)
    #     print("Resolving with Cloudflare DNS...")
    #     resolve_doh(CLOUDFLARE_DNS_HTTPS, CLOUDFLARE_DNS_HTTPS, session=session)
